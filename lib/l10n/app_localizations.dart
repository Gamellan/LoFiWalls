...
const Map<String, Map<String, String>> _localizedValues = {
  'en': {
    ...
    'sortRandom': 'Random',
    'retry': 'Retry',
    'searchHint': 'Search: rem, miku, zero two...',
    'popularSearches': 'Popular searches',
    'noResultsFor': 'No results for "{query}"',
    'favoritesBadge': 'Favorites',
    'favoritesBadgeCount': 'Favorites ({count})',
    'noFavoritesYet': 'No favorites yet',
    'favoritesEmptySubtitle': 'Tap â™¡ on any wallpaper\nto save it here',
    'unknown': 'Unknown',
    'source': 'Source',
  ...
  'es': {
    ...
    'favoritesEmptySubtitle': 'Toca â™¡ en cualquier wallpaper\npara guardarlo aqui',
    'unknown': 'Desconocido',
    'source': 'Fuente',
  ...
  'pt': {
    ...
    'favoritesEmptySubtitle': 'Toque em â™¡ em qualquer wallpaper\npara salvar aqui',
  ...
  'fr': {
    ...
    'favoritesEmptySubtitle': 'Touchez â™¡ sur un wallpaper\npour le sauvegarder ici',
    'unknown': 'Inconnu',
    'source': 'Source',
  ...
  'de': {
    ...
    'favoritesEmptySubtitle': 'Tippe auf â™¡ bei einem Wallpaper\num es hier zu speichern',
    'unknown': 'Unbekannt',
    'source': 'Quelle',
  ...
  'it': {
    ...
    'favoritesEmptySubtitle': 'Tocca â™¡ su qualsiasi wallpaper\nper salvarlo qui',
    'unknown': 'Sconosciuto',
    'source': 'Fonte',
  ...
  'ja': {
    ...
    'favoritesEmptySubtitle': 'å£ç´™ã§ â™¡ ã‚’ã‚¿ãƒƒãƒ—ã™ã‚‹ã¨\nã“ã“ã«ä¿å­˜ã•ã‚Œã¾ã™',
    'unknown': 'ä¸æ˜Ž',
    'source': 'ã‚½ãƒ¼ã‚¹',
  ...
  'ko': {
    ...
    'favoritesEmptySubtitle': 'ì•„ë¬´ ë°°ê²½í™”ë©´ì—ì„œ â™¡ ë¥¼ ëˆ„ë¥´ë©´\nì—¬ê¸°ì— ì €ìž¥ë©ë‹ˆë‹¤',
