...
///  â€¢ Pinch-to-zoom (InteractiveViewer)
///  â€¢ Favorite toggle
///  â€¢ Set as wallpaper (Home / Lock / Both)
///  â€¢ Download to gallery
///  â€¢ Share
///  â€¢ AdMob interstitial on wallpaper set
...
class _DetailScreenState extends ConsumerState<DetailScreen> {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            // â”€â”€ Full-resolution image with pinch-to-zoom â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            InteractiveViewer(
              minScale: 0.5,
              maxScale: 5.0,
              child: Center(
            ...
            // â”€â”€ Animated controls overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            AnimatedOpacity(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.wallpaper.artistName.isNotEmpty ||
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Text(
                                    '(c) ${widget.wallpaper.artistName.isNotEmpty ? widget.wallpaper.artistName : context.l10n.unknown} · ${widget.wallpaper.sourcePlatform.isNotEmpty ? widget.wallpaper.sourcePlatform : context.l10n.source}',
                                    maxLines: 1,
                            ...
                            const Padding(
                              ...
                              child: Text(
                                'Attribution: https://unsplash.com/?utm_source=lofi_walls&utm_medium=referral',
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
            ...
            // â”€â”€ Download progress overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            if (_isBusy)
              Container(
  ...
  // â”€â”€ Bottom sheet: choose wallpaper target â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Set wallpaper flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Future<void> _setWallpaper(int location) async {
    ...
    try {
      ...
      // Notify ad manager â†’ shows interstitial every N sets
      ref.read(adManagerProvider.notifier).onWallpaperSet();

      if (mounted) {
        setState(() => _isBusy = false);
        _snack('âœ“ ${l10n.wallpaperSetSuccess}', color: AppTheme.primaryColor);
      }
    } catch (e) {
      if (mounted) {
        setState(() => _isBusy = false);
  ...
  // â”€â”€ Download to gallery flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  Future<void> _download() async {
    ...
    try {
      final filePath = await _ensureLocalFile();
      await Gal.putImage(filePath, album: 'LoFiWalls');
      if (mounted) {
        setState(() => _isBusy = false);
        _snack('âœ“ ${l10n.gallerySavedSuccess}', color: AppTheme.primaryColor);
      }
    } catch (e) {
      if (mounted) {
        setState(() => _isBusy = false);
  ...
  Future<String> _ensureLocalFile() async {
    ...
    final filePath = '${dir.path}/lofiwalls_${widget.wallpaper.id}.jpg';
